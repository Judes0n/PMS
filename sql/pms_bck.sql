...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 13, 2023 at 08:22 PM
...
--
ALTER TABLE `acc`
  MODIFY `acc_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;
...
--
ALTER TABLE `users`
  MODIFY `u_id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;
