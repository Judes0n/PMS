...
include('../php/connection.php');
   ...
   // $name = $_POST["name"];
    ...
    {
      $sql="INSERT INTO acc(u_id,mid,fname,age,bday,relg,cnct,addrss,gender,income,height,wight,educ,occup,img,insta,lim,stats) VALUES('$uid','$mid','$fname','$age','$bday','$relg','$cnct','$addrs','$gender','$inc','$height','$weight','$educ','$occup','$fileName','0','$insta','0')";
