...
<html lang="zxx">
<head>
<title>Presentation Matrimony Service | ACCOUNT </title>
<!-- Meta tag Keywords -->
...
<div class="Main-agile">
	...
	<div class="agile-top">
		...
		<div class="ph-agile">
			<p><i class="fa fa-phone" aria-hidden="true"></i><span>+91 123 456 7890</span></p>
		</div>
		<div class="clearfix"></div>

		<div class="sub-agile">
			<div class="col-md-6 logo" id="top">
				<h1><a href="<?php if(isset($_SESSION['app_status'])){ echo "home.php"; } ?>">HOME</a></h1>
			</div>
				...
				<div class="header-right">
					...
					<div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">					
						<ul class="nav navbar-nav navbar-left">
                            <li><a href="<?php if(isset($_SESSION['app_status'])){ echo "home.php";}?>" onclick="<?php if(isset($_SESSION['app_status'])){ echo "homep();";}?>" class="link link--yaku scroll" ><span>H</span><span>O</span><span>M</span><span>E</span></a></li>							
							<script>// onclick="hme()"  function hme(){ top.location="home.php"}</script>
							<!--<li><a href="#news" class="link link--yaku scroll"><span>N</span><span>E</span><span>W</span><span>S</span></a></li>
							<li><a href="#founders" class="link link--yaku scroll"><span>F</span><span>O</span><span>U</span><span>N</span><span>D</span><span>E</span><span>R</span><span>S</span></a></li>
							...
							<li class="active"><a href="#"><span>M</span><span>Y</span><t> </t><span>A</span><span>C</span><span>C</span><span>O</span><span>U</span><span>N</span><span>T</span></a></li>
								...
								<div class="modal-content">
									<div class="modal-header">
										<button type="button" class="close" data-dismiss="modal">&times;</button>
											...
											<img src="images/bg2.jpg" alt="blog-image" />
		...
		<div id="reg" name="reg">
			...
			<iframe src="reg/accreg.php" width="100%" height="1700px" frameborder="0"></iframe>
...
<div class="footer w3ls">
	<div class="container">
			<div class="logo-fo">
				<h2><a href="home.html">Presentation Matrimony Services</a></h2>
			</div>
			<div class="ftr-menu">
				 <ul>
